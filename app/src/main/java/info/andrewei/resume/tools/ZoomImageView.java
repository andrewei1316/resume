...

{
	...
	public void setImageCenter(float screenW, float screenH, ZoomImageView imageView){
		imageView.postDelayed(new AutoScaleRunnable(getScale(),(float) (screenW/2.0), (float) (screenH/2.0)), 16);
	}
}
