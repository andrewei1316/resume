...
public class OnlineInfo extends MyFragmentTool implements ViewPager.OnPageChangeListener, View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_online_info, container, false);
        this.mView = view;
        initView();
        initLineImage();
        return view;
    ...
    private void initView() {
        myViewPager = (ViewPager) mView.findViewById(R.id.vp_online_info);
        Page1MyWeibo myFragment1 = new Page1MyWeibo();
        Page2MyBlog myFragment2 = new Page2MyBlog();
        Page3MyGithub myFragment3 = new Page3MyGithub();
        ...
        tv_tab0 = (TextView) mView.findViewById(R.id.text_weibo);
        tv_tab1 = (TextView) mView.findViewById(R.id.text_blog);
        tv_tab2 = (TextView) mView.findViewById(R.id.text_github);
        line_tab = (ImageView) mView.findViewById(R.id.line_tab2);
